...
function Column({ column, createNewCard, deleteColumnDetails }) {
  ...
  const dndKitColumnStyles = {
    ...
    transition,
    // Chiều cao phải luôn max 100% vì nếu không sẽ lỗi nếu không có column ngắn qua một cái column dài thì phải kéo ở khu vực giữa giữa rất khó chịu. Lưu ý lúc này phải kết hợp với {...listeners} nằm ở Box chứ không phải ở div ngoài cùng để tránh trường hợp kéo vào vùng xanh.
    height: '100%',
  ...
  // Cards đã được sắp xếp ở component cha cao nhất (boards/_id.jsx) 71
  ...
  const addNewCard = () => {
    ...
    const newCardData = {
      title: newCardTitle,
      // columnId: '67dd2557d12aa921769c2f18'
      columnId: column._id
      // the data is conver to String in backend before send to backend
    }
     ...
     */
    console.log('Column ID in column.jsx:', column._id)
    console.log('Type of Column ID in column.jsx:', typeof column._id)
